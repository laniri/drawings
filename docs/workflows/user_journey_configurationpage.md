...
| system_task_6 | serviceTask | GET Request to /api/v1/config/ | actor=system |
| system_task_7 | serviceTask | GET Request to /api/v1/models/age-groups | actor=system |
| system_task_8 | serviceTask | GET Request to /api/v1/config/subject-statistics | actor=system |
| system_task_9 | serviceTask | PUT Request to /api/v1/config/threshold | actor=system |
| system_task_10 | serviceTask | PUT Request to /api/v1/config/age-grouping | actor=system |
...
- GET Request to /api/v1/config/
- GET Request to /api/v1/models/age-groups
- GET Request to /api/v1/config/subject-statistics
- PUT Request to /api/v1/config/threshold
- PUT Request to /api/v1/config/age-grouping

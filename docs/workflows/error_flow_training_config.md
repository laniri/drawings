# Error Flow - Training Config

**Workflow ID**: `error_flow_training_config`
**Type**: Error Flow
**Last Updated**: Unknown

## Overview

Error handling workflow for training_config
...
| error_event_5 | errorEvent | ValidationError Error | error_type=ValidationError |
| recovery_task_6 | task | Handle ValidationError | recovery=True |
...
The BPMN 2.0 diagram for this workflow is available as `error_flow_training_config.bpmn`.

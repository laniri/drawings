# Error Flow - Embedding Serialization

**Workflow ID**: `error_flow_embedding_serialization`
**Type**: Error Flow
**Last Updated**: Unknown

## Overview

Error handling workflow for embedding_serialization
...
The BPMN 2.0 diagram for this workflow is available as `error_flow_embedding_serialization.bpmn`.

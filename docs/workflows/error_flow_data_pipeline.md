# Error Flow - Data Pipeline

**Workflow ID**: `error_flow_data_pipeline`
**Type**: Error Flow
**Last Updated**: Unknown

## Overview

Error handling workflow for data_pipeline
...
| error_event_3 | errorEvent | ImagePreprocessingError Error | error_type=ImagePreprocessingError |
| recovery_task_4 | task | Handle ImagePreprocessingError | recovery=True |
...
The BPMN 2.0 diagram for this workflow is available as `error_flow_data_pipeline.bpmn`.

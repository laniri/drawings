# Error Flow - Embedding Service

**Workflow ID**: `error_flow_embedding_service`
**Type**: Error Flow
**Last Updated**: Unknown

## Overview

Error handling workflow for embedding_service
...
The BPMN 2.0 diagram for this workflow is available as `error_flow_embedding_service.bpmn`.

...
class FileStorageService:
    ...
    def __init__(self, base_upload_dir: str = None, base_static_dir: str = None):
        ...
        logger.info(f"FileStorageService initialized - Upload: {self.upload_dir}, Static: {self.static_dir}")
    ...
    async def save_uploaded_file(self, file: UploadFile, subdirectory: str = "drawings") -> Tuple[str, str]:
        ...
        try:
            ...
            unique_filename = self.generate_unique_filename(file.filename or "unknown.png")

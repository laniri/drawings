...
class UsageMetricsService:
    ...
    def record_analysis(
        ...
        with self._lock:
            ...
            logger.debug(f"Recorded analysis metric: {age_group}, {processing_time:.2f}s")
    ...
    def get_dashboard_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            uptime_percentage = min(99.9, (uptime_seconds / (uptime_seconds + 60)) * 100)  # Assume 1 min downtime max
    ...
    def _aggregate_daily(self, metrics: List[AnalysisMetric]) -> List[Dict[str, Any]]:
        ...
        for date_str, data in sorted(daily_data.items()):
            avg_time = data["total_processing_time"] / data["count"] if data["count"] > 0 else 0
            result.append({
                "date": date_str,
    ...
    def _aggregate_weekly(self, metrics: List[AnalysisMetric]) -> List[Dict[str, Any]]:
        ...
        for metric in metrics:
            ...
            week_start = metric.timestamp.date() - timedelta(days=metric.timestamp.weekday())
    ...
    def cleanup_old_metrics(self, days_to_keep: int = 30):
        ...
        with self._lock:
            ...
            # Clean daily stats
            old_dates = [
                date_str for date_str in self._daily_stats.keys()
    ...
    def get_service_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "service_uptime_seconds": int((datetime.utcnow() - self._start_time).total_seconds()),
                "namespace": self.namespace
            }

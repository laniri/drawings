...
from app.models.database import Drawing, DrawingEmbedding, AgeGroupModel, AnomalyAnalysis, InterpretabilityResult
...
class BackupService:
                    ...
                    if upload_dir.exists():
                        for file_path in upload_dir.rglob("*"):
                            if file_path.is_file():
                                arc_path = f"uploads/{file_path.relative_to(upload_dir)}"
    ...
    async def export_data(self, format: str = "json", include_embeddings: bool = False) -> Dict[str, Any]:
        """
    ...
    async def _export_json(self, export_name: str, include_embeddings: bool) -> Dict[str, Any]:
        """Export data as JSON."""
        ...
        return {
            ...
            "record_counts": {
                ...
                "interpretability_results": len(export_data["interpretability_results"])
            },
            "includes_embeddings": include_embeddings,
            "status": "completed"
        }
    
    async def _export_csv(self, export_name: str, include_embeddings: bool) -> Dict[str, Any]:
        ...
        try:
            ...
            tables = ["drawings", "age_group_models", "anomaly_analyses", "interpretability_results"]
                ...
                if rows:
                    ...
                    with open(csv_path, 'w', newline='', encoding='utf-8') as csvfile:
                        ...
                        for row in rows:
                            ...
                            if table == "drawing_embeddings" and "embedding_vector" in row_dict:
    ...
    async def restore_from_backup(self, backup_path: Union[str, Path]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if backup_path.suffix == '.zip':
                ...
                raise ConfigurationError(f"Unsupported backup format: {backup_path.suffix}")

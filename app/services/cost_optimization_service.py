...
class CostOptimizationService:
    ...
    def estimate_monthly_costs(self) -> List[ResourceCostEstimate]:
        ...
        estimates.append(ResourceCostEstimate(
    ...
    def get_total_estimated_cost(self) -> Tuple[float, bool]:
        ...
        is_within_budget = (
            self.config.target_monthly_cost_min <= total_cost <= self.config.target_monthly_cost_max
        )
    ...
    def setup_cost_monitoring(self) -> bool:
        ...
        try:
            ...
            budget_name = f"children-drawing-{settings.env_config.environment.value}-budget"
            ...
            logger.info(f"Cost monitoring configured with ${self.config.monthly_budget_limit} budget")

...
class Drawing(Base):
    ...
    # Relationships
    embeddings = relationship("DrawingEmbedding", back_populates="drawing", cascade="all, delete-orphan")
    analyses = relationship("AnomalyAnalysis", back_populates="drawing", cascade="all, delete-orphan")
...
class AnomalyAnalysis(Base):
    ...
    id = Column(Integer, primary_key=True)
    drawing_id = Column(Integer, ForeignKey("drawings.id"), nullable=False)
    age_group_model_id = Column(Integer, ForeignKey("age_group_models.id"), nullable=False)
    ...
    interpretability = relationship("InterpretabilityResult", back_populates="analysis", cascade="all, delete-orphan")
...
class TrainingJob(Base):
    ...
    # Relationships
    training_reports = relationship("TrainingReport", back_populates="training_job", cascade="all, delete-orphan")

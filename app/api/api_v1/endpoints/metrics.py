    ...
    try:
        ...
        system_info = {
            ...
            "service": {
                ...
                "version": "1.0.0",
                "environment": "production" if metrics_service._cloudwatch_enabled else "development"
            }
        }
    ...
    try:
        ...
        with metrics_service._lock:
            analysis_metrics = {
                ...
                "recent_processing_times": list(metrics_service._analysis_metrics.processing_times)[-10:],
            ...
            system_metrics = {
                ...
                "recent_response_times": list(metrics_service._system_health.response_times)[-10:],
...
async def get_cloudwatch_status() -> Dict[str, Any]:
    ...
    return {
        ...
        "aws_region": getattr(metrics_service._cloudwatch_client, 'meta', {}).get('region_name') if metrics_service._cloudwatch_client else None,
